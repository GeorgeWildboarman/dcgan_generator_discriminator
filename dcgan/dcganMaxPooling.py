...
def build_discriminator(
  ...
  # conv1
  model.add(tf.keras.layers.Conv2D(num_filters, disc_kernel_size, strides=(1, 1), padding='same', input_shape=input_shape))
  ...
  # conv2
  model.add(tf.keras.layers.Conv2D(num_filters*2, disc_kernel_size, strides=(1, 1), padding='same'))
  model.add(tf.keras.layers.MaxPooling2D(pool_size=(2, 2)))
  if batchnorm:
    model.add(tf.keras.layers.BatchNormalization())
  model.add(tf.keras.layers.LeakyReLU())
  ...
  # conv3
  model.add(tf.keras.layers.Conv2D(num_filters*4, disc_kernel_size, strides=(1, 1), padding='same'))
  model.add(tf.keras.layers.MaxPooling2D(pool_size=(2, 2)))
  if batchnorm:
    model.add(tf.keras.layers.BatchNormalization())
  model.add(tf.keras.layers.LeakyReLU())
  ...
  # conv4
  model.add(tf.keras.layers.Conv2D(num_filters*8, disc_kernel_size, strides=(1, 1), padding='same'))
  model.add(tf.keras.layers.MaxPooling2D(pool_size=(2, 2)))
  if batchnorm:
    model.add(tf.keras.layers.BatchNormalization())
  model.add(tf.keras.layers.LeakyReLU())
